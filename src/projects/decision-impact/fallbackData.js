...
export const FALLBACK_ORG_MODEL = {
  ...
  "interdependencies": [
    ...
    },
    {
      ...
      "lag_months": 1,
      "relationship": "inverse",
      "source": "Working capital released ~ $200M revenue / 365 ~ $0.55M per DSO day; FCF impact modeled as a conservative -0.28 elasticity, not the gross release",
      "notes": "A 10-day DSO reduction releases ~$5.5M of working capital; the -0.28 elasticity flows ~$0.7M of that to free cash flow within the period (the rest offsets payables/timing)."
    },
    {
  ...
  "scenarios": [
    {
      ...
      "narrative": "Cutting marketing spend 15% reduces qualified lead flow about 10% within a quarter, contracting the sales pipeline by roughly $2.4M (-5.4%). That saves $1.3M in direct marketing cost, but on this model the pipeline contraction outweighs the saving within two quarters. Brand awareness erodes about 6% over 3+ months; the leaner pipeline even nudges win rate +0.8% as fewer early-stage deals dilute it \u2014 a small second-order effect."
    },
    {
      ...
      "narrative": "Freezing engineering hiring for a quarter (~12% fewer engineers) slows feature delivery about 3.6% \u2014 sub-linear, per Brooks's Law. Product NPS slips about 1.4% over two quarters and win rate eases -0.4% as the roadmap falls behind. The salary savings are real but partly offset by reduced product competitiveness."
    },
    {
      ...
      "narrative": "Reducing DSO by 10 days releases roughly $5.5M of working capital (~$0.55M per DSO day on ~$200M revenue). Modeled conservatively, about $0.7M of that lands in free cash flow within the period (+5.8%), funding incremental engineering and marketing reinvestment. One of the few moves with mostly positive cascades; the trade-off is tighter collection terms with customers."
    },
    {
      ...
      "narrative": "A 10% operations budget cut pushes the fulfillment rate to about 89.8% (-7.0%), under the 90% service line. Customer satisfaction slips about 5.6%, and with a two-month lag monthly churn rises roughly +0.05 percentage points (+2.8%). The LTV drag compounds over ~12 months \u2014 operations cuts carry the longest, most damaging cascade modeled here."
    },
    {
      "id": "custom",
